...
import com.projectz.service.{ LoanRecordServiceImpl, ProductService, ProductServiceImpl}
...
//  @Provides
//  def providesLoanRecordRepository(): LoanRecordRepository[String, LoanRecord] = {
//    new LoadRecordStore()
//  }
}
